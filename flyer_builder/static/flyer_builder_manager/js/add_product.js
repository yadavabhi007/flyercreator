App.add_product = {
    ...
    init: function () {
        App.add_product.init_catagory_select();
        App.add_product.init_file_input();
    },

    init_catagory_select: function () {
        $('#add-product-form_category').change(function () {
            App.show_loader()
            ...
            $.ajax({
                ...
                .done(function (data) {
                    $("#add-product-form_subcategory").html(data);
                })
                .fail(function () {
    ...
    init_file_input: function () {
        ...
        $('#add-product-form_images').on('change', function () {
