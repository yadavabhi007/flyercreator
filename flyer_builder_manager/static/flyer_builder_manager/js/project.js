App.project = {
    ...
    show_header: function () {
        ...
        $(".closebtn").show()
        $("#theme_header_banner").show()
        $("#theme_footer_banner").hide()
        $("#theme_half_page").hide()
        $("#theme_full_page").hide()
    },
    show_footer: function () {
        ...
        document.getElementById("center").style.left = "473px";
        $(".closebtn").show()
        $("#theme_footer_banner").show()
        $("#theme_half_page").hide()
        $("#theme_header_banner").hide()
        $("#theme_full_page").hide()
        
    },
    show_full_page: function () {
        document.getElementById("mySidenav").style.width = "240px";
        document.getElementById("mySidenav").style.overflow = "overlay";
        document.getElementById("center").style.left = "473px";
        $(".closebtn").show()
        $("#theme_full_page").show()
        $("#theme_half_page").hide()
        $("#theme_footer_banner").hide()
        $("#theme_header_banner").hide()
    },
    show_half_page: function () {
        document.getElementById("mySidenav").style.width = "240px";
        document.getElementById("mySidenav").style.overflow = "overlay";
        document.getElementById("center").style.left = "473px";
        $(".closebtn").show()
        $("#theme_full_page").hide()
        $("#theme_half_page").show()
        $("#theme_footer_banner").hide()
        $("#theme_header_banner").hide()
    },
